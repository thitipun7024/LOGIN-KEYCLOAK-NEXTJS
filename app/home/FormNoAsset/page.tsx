    ...
    <div className="flex flex-col justify-center items-center min-h-screen">
      <div className="absolute top-0 left-0 right-0 lg:h-64 md:h-56 sm:h-48 h-52 bg-blue-950 transform rounded-b-3xl">
        ...
        <a href="/home">
          ...
          <h1 className="mb-7 mt-3 lg:text-4xl md:text-3xl sm:text-2xl text-2xl font-bold">
            รายการสินทรัพย์ที่ไม่มีเลข Asset
          </h1>

          <div className="btn btn-primary border-0 bg-blue-500 mb-5">
            <a 
              className="text-xl text-white"
              href="/home/FormNoAsset/AddAsset"
            >
                เพิ่มสินทรัพย์ +
            </a>
          </div>
          ...
          <div className="container flex items-center justify-center mb-3">
                <div className="card lg:w-9/12 md:w-3/4 sm:w-3/4 w-11/12 h-28 bg-white border-dashed border-2 border-blue-950 text-neutral-content shadow-xl flex flex-row items-center">
                  <img
                  ...
                  <div className="flex flex-col lg:ml-5 ml-0">
                    <h1 className="lg:text-3xl md:text-1xl sm:text-xl text-2xl font-bold text-blue-950 break-words w-40">
                      test
                    </h1>
                  </div>
